...
class UserExtendedAttributesEvent extends Event {
	 ...
	 * The reason to use appName as one of the keys is its easier to know if the
	 * attributes are set for the app. If we don't use the appName then the the list
	 * would be a scattered with attributes and it won't look nice.
	 *
	 * @param string $attributeKey
	 * @param mixed $attributeValue
	 * @return bool true if the attribute is set by the method false if the attribute is already present
	 */
